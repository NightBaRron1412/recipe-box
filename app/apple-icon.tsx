...
/** iOS ignores the web-app manifest icon for Add to Home Screen. Next.js emits
 * this metadata route as the required apple-touch-icon link. */
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img
          src={`data:image/svg+xml,${encodeURIComponent(HAT)}`}
          width={116}
          height={116}
          alt=""
        />
